...
PUBLICATION_DATES = {
    ...
    "B200": datetime(2025, 4, 17),     # 17 апреля 2025
...
PERGOLA_IMAGES = {
    ...
    "B200": [
        "flask_app/static/images/b200.jpg"
    ],
    "MODULAR": [
...
PERGOLA_IMAGE_CAPTIONS = {
    ...
    "B200": "Пергола B200 MAF AERO FLAT со стационарными ламелями",
...
B200_DESCRIPTION = """
<h3>Серия B200 MAF AERO FLAT (стационарные ламели)</h3>
<p style='margin-bottom: 15px;'>
Биоклиматическая пергола со стационарными алюминиевыми ламелями 200×50 мм. Доступна в двух геометриях ламели — AERO (аэродинамические, наклонные) и FLAT (плоские, вертикальные «римский стиль») — каждая с двумя вариантами шага (20 и 25 см). Итого 4 модификации: AERO-20, AERO-25, FLAT-20, FLAT-25. Оптимальна для навесов, беседок и перголовых карнизов большого пролёта.
</p>

<section style='margin-bottom: 15px;'>
<strong>Конструкция:</strong><br/>
• Ламели: 200×50 мм (стационарные, нерегулируемые), алюминий с порошковым покрытием.<br/>
• Колонна: 100×100 мм, алюминиевый профиль.<br/>
• Несущая балка: 200×50 мм.<br/>
• Вынос: до 12,1 м (при больших пролётах конструкция усиливается промежуточными опорами — их стоимость включена в цену).
</section>

<section style='margin-bottom: 15px;'>
<strong>Тип ламели — AERO или FLAT:</strong><br/>
• <strong>AERO</strong> — ламель аэродинамической каплевидной формы, установлена под углом к поверхности. Лучше отводит косой дождь, даёт больше тени и премиальный визуальный эффект. Подходит для южных регионов, бассейнов, открытых террас.<br/>
• <strong>FLAT</strong> — плоская прямоугольная ламель, расположена вертикально. Классический «римский» стиль, лаконичная геометрия. Подходит для садовых перголовых карнизов и беседок в спокойном минималистичном стиле.<br/>
<em>Цена AERO и FLAT при одинаковом шаге одинакова — отличается только геометрия ламели.</em>
</section>

<section style='margin-bottom: 15px;'>
<strong>Шаг ламелей:</strong><br/>
• Шаг 20 см — более плотная крыша (затенение 70–75%, лучше защита от дождя).<br/>
• Шаг 25 см — более лёгкая конструкция (затенение 60–65%, больше воздуха и света).
</section>

<section style='margin-bottom: 15px;'>
<strong>Преимущества:</strong><br/>
• Максимальный вынос до 12,1 м — рекорд среди серий Decolife (промежуточные опоры при больших пролётах включены в цену).<br/>
• Низкий вес конструкции (15–18 кг/м²).<br/>
• Экономичная цена по сравнению с поворотными системами.<br/>
• LED/RGB подсветка по периметру (опция).<br/>
• Дополнительные колонны уже включены в стоимость.
</section>
"""
