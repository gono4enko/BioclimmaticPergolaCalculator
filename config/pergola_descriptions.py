...
<div style='padding: 0 20px;'>
<h3 style='font-size: 1.2rem; margin-top: 20px; text-align: center;'>Монтаж биоклиматической перголы</h3>
<p style='margin-bottom: 15px;'>
Процесс монтажа биоклиматической перголы выполняется в несколько этапов квалифицированными специалистами и занимает от 1 до 3 дней в зависимости от сложности конструкции и количества модулей.
</p>

<div style='margin-bottom: 15px;'>
<strong>Этапы установки:</strong><br/>
1. Подготовка основания (бетонной стяжки или фундаментных блоков)<br/>
2. Сборка и установка несущего каркаса<br/>
3. Монтаж водоотводящей системы<br/>
4. Установка ламелей и механизма поворота<br/>
5. Подключение автоматики и электропривода<br/>
6. Настройка и тестирование системы
</div>

<p style='margin-bottom: 15px;'>
Все соединения выполняются с использованием высококачественного крепежа из нержавеющей стали. Для герметизации соединений применяются специальные уплотнители и герметики.
</p>
</div>
"""
