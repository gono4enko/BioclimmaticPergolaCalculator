...
def get_bioclimatic_install_description():
    """
    Возвращает описание вариантов установки и вертикальных систем для всех типов пергол
    
    Returns:
        str: HTML-описание вариантов установки и вертикальных систем
    """
...
# Описание вариантов установки и вертикальных систем
...
<p style='margin-bottom: 15px;'>Биоклиматическая пергола — это не просто навес, а архитектурный элемент, который адаптируется под ваши потребности. Выберите свой сценарий:</p>
<ol style='margin-bottom: 10px; padding-left: 20px;'>
...
<p style='margin-bottom: 15px;'>Защитите пространство от ветра, дождя и солнца, не жертвуя светом и видами.</p>
<ol style='margin-bottom: 10px; padding-left: 20px;'>
...
# Изображение для вариантов установки
PERGOLA_IMAGES["INSTALL_SYSTEM"] = [
    "attached_assets/install_design_system.png"
]

# Подпись к изображению вариантов установки
PERGOLA_IMAGE_CAPTIONS["INSTALL_SYSTEM"] = "Варианты установки и вертикальные системы"
