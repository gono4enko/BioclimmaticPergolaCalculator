...
<h4>Ламели:</h4>
<ul>
    <li><strong>250x53 мм (NEW):</strong> Угол поворота 105°, шаг 250 мм, масса 4,684 кг/м.</li>
    <li><strong>200x56 мм (NEW):</strong> Угол поворота 112°, шаг 200 мм, масса 4,375 кг/м.</li>
</ul>

<h4>Преимущества:</h4>
<ul>
    <li>Высокая герметичность благодаря двойному уплотнению.</li>
    <li>Интегрированная дренажная система с лотком 164x260 мм.</li>
    <li>Быстрый монтаж (до 4 часов на модуль).</li>
    <li>LED/RGB подсветка по периметру (опция).</li>
    <li>Максимальный пролет до 8 м.</li>
</ul>

<h4>Узлы:</h4>
<ul>
    <li><strong>Несущая балка:</strong> Алюминиевая конструкция с двойным сливным лотком (322x260 мм).</li>
    <li><strong>Колонна:</strong> 164x164 мм, усиленная 7 анкерами для устойчивости.</li>
    <li><strong>Система вращения:</strong> Немецкий двигатель Bansbach easylift (IP65), синхронизация TANDEM для больших конструкций.</li>
</ul>
"""
...
<h4>Ламели:</h4>
<ul>
    <li><strong>250x46 мм:</strong> Сдвиг с углом 107°, шаг 250 мм, масса 4,144 кг/м.</li>
    <li><strong>200x56 мм (NEW):</strong> Сдвиг с углом 107°, шаг 200 мм, масса 4,375 кг/м.</li>
</ul>

<h4>Преимущества:</h4>
<ul>
    <li>Высокая ветровая устойчивость (до 50 кг/м² снеговой нагрузки).</li>
    <li>Французские двигатели Somfy с защитой IP65.</li>
    <li>Возможность интеграции с панорамным остеклением.</li>
</ul>

<h4>Узлы:</h4>
<ul>
    <li><strong>Несущая балка:</strong> Двойной лоток 322x260 мм для отвода воды.</li>
    <li><strong>Колонна:</strong> Усиленная конструкция с дренажными отверстиями.</li>
    <li><strong>Система сдвига:</strong> Замок Roof-Lock для герметичности.</li>
</ul>
"""
...
<ul>
    <li><strong>Панели PIR:</strong> Толщина 100 мм, замок Rolf-Lock, RAL 9003/7024.</li>
    <li><strong>Максимальный пролет:</strong> До 8 м.</li>
</ul>

<h4>Преимущества:</h4>
<ul>
    <li><strong>Снеговая нагрузка</strong> до 100 кг/м².</li>
    <li><strong>Термоизоляция</strong> и защита от шума.</li>
    <li><strong>Экологичность</strong> и устойчивость к УФ-излучению.</li>
</ul>

<h4>Узлы:</h4>
<ul>
    <li><strong>Сэндвич-панели:</strong> Трехслойная конструкция с пенополиизоциануратом.</li>
    <li><strong>Колонна:</strong> 164x164 мм с жестким креплением.</li>
    <li><strong>Дренаж:</strong> Интегрированный лоток по периметру.</li>
</ul>
"""
