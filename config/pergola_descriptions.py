...
def get_lamella_engineering_description(pergola_type=None):
    ...
    """
    return """
    <h3 style='font-size: 1.2rem; margin-top: 30px; text-align: center;'>Технические характеристики ламелей</h3>
    <p style='margin-bottom: 15px;'>
    Алюминиевые ламели являются основным рабочим элементом биоклиматических пергол, 
    ...
    • Размер: 200×56 мм<br/>
    • Масса: 4,375 кг/м<br/>
    • Угол поворота: 112° для B500, угол сдвига 107° для B700<br/>
    ...
    • Угол поворота: 105° для B500, угол сдвига 107° для B700<br/>
    • Материал: алюминиевый сплав 6063 с защитным анодированием<br/>
    • Толщина стенки: 3 мм
    </section>
    """
