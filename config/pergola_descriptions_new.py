...
<ul>
    <li><strong>2 варианта под любые нагрузки:</strong>
        <ul>
            <li>Стандартный лоток 164×280 мм: Пропускная способность — 15 л/с (подходит для 90% регионов).</li>
            <li>Усиленный лоток 322×280 мм: Пропускает 30 л/с — для тропических ливней или больших площадей.</li>
        </ul>
    </li>
</ul>
