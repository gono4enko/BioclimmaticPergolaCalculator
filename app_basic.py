...
def render_results(results):
    ...
    if pergola_type == "B500NEW":
        ...
        st.markdown(f"""
        <h3 style='font-size: 1.2rem; margin-top: 20px;'>Серия B600 (с PIR-панелями)</h3>
        <p style='margin-bottom: 15px;'>
        Стационарная пергола с PIR-панелями для полной защиты от солнца и осадков.
        Идеальное решение для всесезонной эксплуатации с максимальной теплоизоляцией.
        </p>
        
        <div style='margin-bottom: 15px;'>
        <strong>Преимущества:</strong><br/>
        • Отличная теплоизоляция благодаря PIR-панелям.<br/>
        • Высокая водонепроницаемость.<br/>
        • Минимальное обслуживание (отсутствие движущихся частей).<br/>
        • Возможность установки в любое время года.<br/>
