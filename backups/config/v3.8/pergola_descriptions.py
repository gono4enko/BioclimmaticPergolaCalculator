...
def get_bioclimatic_install_description():
    ...
    """
    return """
    <h3 style='font-size: 1.2rem; margin-top: 30px; text-align: center;'>Технология монтажа биоклиматических пергол</h3>
    <p style='margin-bottom: 15px;'>
    Биоклиматические перголы устанавливаются по специально разработанной технологии, 
    ...
    • Установка несущих балок и системы водоотведения<br/>
