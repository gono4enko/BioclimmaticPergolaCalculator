...
PERGOLA_TYPES = {
    ...
    "B700NEW": {
        ...
        "description": "Премиальная пергола B700NEW с поворотно-сдвижными ламелями. Комбинированная система позволяет как поворачивать, так и сдвигать ламели для максимального контроля. Включает автоматизацию Somfy с автоматическим подбором типа привода.",
