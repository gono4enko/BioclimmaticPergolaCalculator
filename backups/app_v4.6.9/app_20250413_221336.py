...
def main():
    ...
    # Центрируем кнопку по горизонтали через специальный HTML/CSS
    st.markdown("""
    <style>
    ...
    /* Стили для кнопки внутри контейнера */
    ...
    # Отображаем кнопку через встроенный div-контейнер со стилями
    with st.container():
    ...
    st.markdown("<div style='text-align: center; font-size: 0.7rem; color: #999;'>© 2025 Комфортный дом | Калькулятор пергол v4.6.9</div>", unsafe_allow_html=True)
