document.addEventListener('DOMContentLoaded', function() {
    ...
    function getBayZipQs(side, count, xPerBay) {
        if (!state.zipPerOpening) return '';
        var parts = [];
        var idx = 1;
        var sections = (xPerBay > 0) ? (xPerBay + 1) : 1;
        for (var i = 0; i < count; i++) {
            var z = state.zipPerOpening[side + '_' + i];
            var enabled = !!(z && z.enabled);
            for (var j = 0; j < sections; j++) {
                if (enabled) parts.push('zip_' + idx + '=1');
                idx++;
            }
        }
        return parts.length ? ('&' + parts.join('&')) : '';
    ...
    function updateSchemeForVariant(r) {
        ...
        var _zipF = getBayZipQs('front', parseInt(m) || 1, _xcF);
        var _zipB = getBayZipQs('back', parseInt(m) || 1, _xcB);
    ...
    function buildMarketingKP(resultOrResults, decoData) {
        ...
        var specHints = {
            ...
            'ZIP130': 'ZIP130 \u2014 \u0443\u0441\u0438\u043b\u0435\u043d\u043d\u044b\u0439 \u043a\u043e\u0440\u043e\u0431 100\u00d7130 \u043c\u043c, \u043c\u0430\u043a\u0441. 25 \u043c\u00b2. \u0414\u043b\u044f \u0448\u0438\u0440\u043e\u043a\u0438\u0445 \u043f\u0440\u043e\u0451\u043c\u043e\u0432, \u0442\u0435\u0440\u0440\u0430\u0441 \u0438 \u043f\u0435\u0440\u0433\u043e\u043b. \u0412\u0430\u043b \u00d878 \u043c\u043c, \u043f\u0440\u043e\u0444\u0438\u043b\u044c 4\u20135 \u043c\u043c. \u042d\u043b\u0435\u043a\u0442\u0440\u043e\u043f\u0440\u0438\u0432\u043e\u0434 Simu RTS \u0438 \u0434\u0430\u0442\u0447\u0438\u043a\u0438 \u0432\u0435\u0442\u0440\u0430/\u0441\u043e\u043b\u043d\u0446\u0430.',
        ...
        if (!isAll && zipRes && zipRes.count > 0) {
            ...
            if (zipTypeKeys.length > 0) {
                ...
                zipTypeKeys.forEach(function(t) {
                    ...
                    var isZ100 = (t === 'ZIP100');
                    var casSize = isZ100 ? '90\u00d7100' : '100\u00d7130';
        ...
        html += '<div class="kp-block">' +
            ...
            (pergolaCount > 0 ? '<div class="kp-stat" style="border-left:2px solid #f59e0b;padding-left:0.5rem;"><div class="kp-stat-number" style="color:#e07b10;">' + pergolaCount + '</div><div class="kp-stat-label">\u0443\u0441\u0442\u0430\u043D\u043E\u0432\u043B\u0435\u043D\u043E \u0432 2026</div></div>' : '') +
            '</div></div>';
