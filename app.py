...
def render_options_form():
    ...
    # Установка
    st.markdown("<div style='margin-top: 0px;'></div>", unsafe_allow_html=True)
    st.markdown("<p style='font-weight: 500; margin-bottom: 0px;'>Установка</p>", unsafe_allow_html=True)
    
    installation = st.checkbox("С установкой", value=True, label_visibility="visible")
...
def main():
    ...
    st.markdown("<div style='text-align: center; font-size: 0.7rem; color: #999;'>© 2025 Комфортный дом | Калькулятор пергол v4.3.4</div>", unsafe_allow_html=True)
